...
const security_password_mock_1 = require("../../services/mocks/security-password-mock");
(0, vitest_1.describe)('Login User', () => {
    ...
    (0, vitest_1.beforeAll)(async () => {
        ...
        if (hashPasswordForTest.success) {
            const initialUsers = [
                (0, user_mock_1.userMock)({ email: 'agustin@gmail.com', password: hashPasswordForTest.data }),
