...
async function deleteProductInCart({ dependencies, payload }) {
    try {
        ...
        if (deleteProductInCart.data === undefined)
            return { success: false, error: 'Unexpected error in delete product to cart' };
...
//# sourceMappingURL=delete-product-in-cart.js.map